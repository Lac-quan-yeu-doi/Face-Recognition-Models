...
def main():
    ...
    print(f"{'*'*10} SPHEREFACE MODEL {'*'*10}")

    # Path
    model_folder_path = f'{WORKING_PATH}/models'
    os.makedirs(model_folder_path, exist_ok=True)
    model_final_path = f'{model_folder_path}/sphereface_final.pth'
    model_best_path = f'{model_folder_path}/sphereface_best.pth'
    ...
    # Initialize Model
    model = SphereFaceNet(num_classes=train_dataset.num_of_identities).to(device)
